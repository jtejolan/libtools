...
| Path | Lines | Purpose | Detail in |
|---|---|---|---|
| `backend/app/bookclub/models.py` | 234 | Club/member/book/meeting/participation/template/question models | `docs/backend/bookclub.md` |
| `backend/app/bookclub/schemas.py` | 387 | Pydantic schemas incl. `PublicXResponse` subset types | `docs/backend/bookclub.md` |
| `backend/app/bookclub/crud.py` | 959 | DB ops for all bookclub entities | `docs/backend/bookclub.md` |
| `backend/app/bookclub/routes.py` | 541 | Members/books/meetings/roster/emails/giveaway/templates/questions (~44 endpoints) | `docs/backend/bookclub.md` |
| `backend/app/bookclub/club_routes.py` | 169 | Club CRUD/switching + public `/api/public/clubs/{slug}` | `docs/backend/bookclub.md` |
...
| `backend/tests/test_bookclub_api.py` | 680 | Bookclub API tests | `docs/backend/bookclub.md` |
...
| `backend/alembic/versions/*.py` (4 files) | Migration scripts, head is `a4af3deaaa80` | `docs/backend/shared.md` |
...
| `frontend/bookclub.html` / `bookclub.js` | 406 / 1514 | Book Club Manager app | `docs/frontend/bookclub.md` |
...
| `frontend/bookclub.css` | 356 | Bookclub app styles | `docs/frontend/bookclub.md` |
