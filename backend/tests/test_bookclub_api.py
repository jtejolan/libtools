...
class BookClubApiTests(unittest.TestCase):
    ...
    def test_homepage_links_to_bookclub_api(self) -> None:
        ...
        self.assertIn('/static/bookclub.js?v=42', entrypoint.text)
        self.assertIn('/static/bookclub.css?v=41', entrypoint.text)
        ...
        self.assertIn('/static/bookclub-manage.css?v=4', community.text)
        self.assertIn('/static/bookclub-manage.js?v=12', community.text)
